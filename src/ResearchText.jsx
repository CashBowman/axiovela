...
export default function ResearchText({text, inline = false}) {
  ...
  return <Tag className="researchText"><Suspense fallback={<span aria-busy="true" aria-label="Loading formatted text">…</span>}><MarkdownPreview source={String(text ?? '')} inline={inline} assetUrl={omitImage}/></Suspense></Tag>;
}
