# Install Axiovela 0.2.6 on Mac

[Download Axiovela 0.2.6](https://github.com/CashBowman/axiovela/releases/tag/v0.2.6) for Apple Silicon or Intel Mac.

Requires macOS 13 or later. For an M1/M2/M3/M4/M5 or other Apple M-series chip, use `Axiovela-0.2.6-darwin-arm64.dmg`. For Intel Macs, use `Axiovela-0.2.6-darwin-x64.dmg`. Check Apple menu → About This Mac if unsure.
...
5. Confirm **Help → About Axiovela** shows **0.2.6**, then choose **Help → Try the example study**.
