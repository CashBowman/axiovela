...
<p align="center"><a href="https://github.com/CashBowman/axiovela/releases/tag/v0.2.4">Download</a> · <a href="docs/quick-start.md">Get started</a> · <a href="docs/features.md">Features</a> · <a href="docs/README.md">Documentation</a> · <a href="https://github.com/CashBowman/axiovela/releases/tag/v0.2.4">Release notes</a></p>
...
Run an experiment, develop a manuscript, and explore another project at the same time. **Axiovela 0.2.4 lets independent chats work concurrently**, so you can keep prompting and reviewing while other tasks continue in the background.
...
**Download Axiovela 0.2.4 · Stable release**

**Windows**

<a href="https://github.com/CashBowman/axiovela/releases/download/v0.2.4/Axiovela-0.2.4-win32-x64-Setup.exe"><img src="https://raw.githubusercontent.com/CashBowman/axiovela/main/docs/assets/downloads/windows.png" alt="Download Windows: Intel / AMD · 64-bit" width="320" height="88" /></a>

[Windows ARM64 · portable ZIP](https://github.com/CashBowman/axiovela/releases/download/v0.2.4/Axiovela-0.2.4-win32-arm64.zip)

**macOS**

<a href="https://github.com/CashBowman/axiovela/releases/download/v0.2.4/Axiovela-0.2.4-darwin-arm64.dmg"><img src="https://raw.githubusercontent.com/CashBowman/axiovela/main/docs/assets/downloads/mac-arm.png" alt="Download Mac · Apple Silicon: M-series chips" width="320" height="88" /></a>
<a href="https://github.com/CashBowman/axiovela/releases/download/v0.2.4/Axiovela-0.2.4-darwin-x64.dmg"><img src="https://raw.githubusercontent.com/CashBowman/axiovela/main/docs/assets/downloads/mac-intel.png" alt="Download Mac · Intel: Intel processors" width="320" height="88" /></a>

**Linux**

<a href="https://github.com/CashBowman/axiovela/releases/download/v0.2.4/Axiovela-0.2.4-linux-x64.zip"><img src="https://raw.githubusercontent.com/CashBowman/axiovela/main/docs/assets/downloads/linux-zip.png" alt="Download Linux: 64-bit · ZIP archive" width="320" height="88" /></a>

[Linux ARM64 · portable ZIP](https://github.com/CashBowman/axiovela/releases/download/v0.2.4/Axiovela-0.2.4-linux-arm64.zip)

[Help choosing a download, portable ZIPs, and release notes](https://github.com/CashBowman/axiovela/releases/tag/v0.2.4)
...
Version 0.2.4 improves Pi Agentic status reporting and enables signed, verified update downloads. Install 0.2.4 manually once from an older version; subsequent compatible releases can be downloaded and verified in the app. Installation remains manual.
